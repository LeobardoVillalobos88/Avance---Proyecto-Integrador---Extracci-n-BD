...
Al igual que en las actividades anteriores, las métricas se comprobaron \textbf{a mano} a partir de la matriz de confusión, bajo el esquema de una clase contra el resto. Para cada clase se definen cuatro cantidades, que son los verdaderos positivos (TP), los falsos negativos (FN), los falsos positivos (FP) y los verdaderos negativos (TN), y con ellas se aplican las fórmulas vistas en clase:
\begin{equation}
